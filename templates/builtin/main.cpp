...
//#pragma GCC optimize("Ofast") //#pragma GCC optimize "unroll-loops" //#pragma GCC target "mmx,sse,sse2,sse3,sse4,avx,avx2,fma,abm,popcnt,tune=native" //#pragma GCC optimize "prefetch-loop-arrays"
...
int main(){
    ...
    bool b;
    char c;
    ll x; i128 xx; //also exists 8,16,32,64 bit, unsigned/signed
    double y; lld yy; //also exists float
    string s;
    vector<int> vi;
    set<int> aa;
    multiset<int> ab;
    map<int,int> ac;
    gp_hash_table<int,int,chash> ad;
    unordered_multiset<int> ae;
    ordered_set<int> af;
    ordered_map<int> ag;
    stack<int> ba;
    queue<int> bb;
